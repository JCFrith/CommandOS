...
/** Error boundary for the workflows surfaces. */
export default function WorkflowsError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="border-destructive/40 bg-destructive/5 mx-auto flex w-full max-w-5xl flex-col items-center rounded-2xl border border-dashed p-12 text-center">
      ...
      <h2 className="mt-4 text-sm font-semibold">Something went wrong loading workflows</h2>
      <p className="text-muted-foreground mt-1 max-w-sm text-sm">
        The workflows surface hit an unexpected error. Try again — if it persists, check the server
        logs.
      </p>
